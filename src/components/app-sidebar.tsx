...
import { Inbox, LayoutDashboard, Lightbulb, Droplet, Hash, ChevronDown, ChevronRight, Sun, Sunset, CalendarDays, Briefcase, FileText, MapPin, Network, Layers } from "lucide-react";
