  ...
  if (!user) {
    return (
      <div className="h-full flex items-center justify-center bg-zinc-950 p-4">
        <div className="max-w-md w-full bg-zinc-900/60 p-8 rounded-2xl border border-zinc-800 text-center space-y-6">
          ...
          <div>
            <h1 className="text-2xl font-black uppercase tracking-tight text-zinc-100">Momentum</h1>
            <p className="text-zinc-500 text-sm mt-2">Zarządzaj czasem, projektami i zadaniami. Zaloguj się, aby kontynuować.</p>
          </div>
          <Button 
            onClick={signInWithGoogle}
            className="w-full bg-white text-black hover:bg-zinc-200 h-12 font-bold flex items-center gap-2"
          >
