...
import { Menu, Scroll, LayoutDashboard, Inbox, Sword, Droplet, Hash, ChevronDown, ChevronRight, Sun, Sunset, CalendarDays, Target, Lightbulb, ListTodo, Rocket, Briefcase } from "lucide-react";
...
export function LayoutWrapper({ children, tags = [], skills = [] }: { children: React.ReactNode, tags?: Tag[], skills?: Skill[] }) {
